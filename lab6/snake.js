...
(function () {
	...
	window.addEventListener("keydown", function (event) {
		...
		switch (event.keyCode) { //appended 'Code' to 'key' so i could use key codes
	...
	Snake.prototype.isFoodEaten = function () {
		...
		return false;
		//above checking to see if the top and left coor. of the snake equal that of the food
		// if yes we want to return true as the food should be eaten=
		// for all other cases we want to return false
	};
